...
% Personally, I set the number of points as 200,
% it could be > 200, Please check spectra figs and use a proper value
len_alias = 200; 
...
for indx_time  = 655
    ...
    [current_spec_V_lin_new, velocity] = ...
        read_nc_LV0__VelocityFold_Ze_normalize(current_spec_V_lin, range_offsets, len_alias, specN ,range  ,maxVel  );
    [current_spec_HV_lin_new, velocity] = ...
        read_nc_LV0__VelocityFold_Ze_normalize(current_spec_HV_lin, range_offsets, len_alias, specN ,range  ,maxVel  );
